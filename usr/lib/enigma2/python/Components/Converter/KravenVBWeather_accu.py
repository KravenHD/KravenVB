...
URL = 'http://api.accuweather.com/forecasts/v1/daily/5day/' + str(config.plugins.KravenVB.weather_accu_id.value) + '?apikey=srRLeAmTroxPinDG8Aus3Ikl6tLGJd94&metric=true&details=true&language=' + str(config.plugins.KravenVB.weather_language.value)
URL2 = 'http://api.accuweather.com/currentconditions/v1/' + str(config.plugins.KravenVB.weather_accu_id.value) + '?apikey=srRLeAmTroxPinDG8Aus3Ikl6tLGJd94&metric=true&details=true&language=' + str(config.plugins.KravenVB.weather_language.value)
