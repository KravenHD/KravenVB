...
URL = 'http://api.openweathermap.org/data/2.5/forecast/daily?' + config.plugins.KravenVB.weather_owm_latlon.value + '&cnt=5&mode=json&appid=89b59e4d7d07894243b5acd24e7f18a3'
WEATHER_DATA = None
WEATHER_LOAD = True
