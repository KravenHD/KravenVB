...
URL = 'http://api.openweathermap.org/data/2.5/forecast/daily?' + config.plugins.KravenVB.weather_owm_latlon.value + '&cnt=5&mode=json&appid=60e502f04cdafb43a8ca88f82c39c033'
WEATHER_DATA = None
WEATHER_LOAD = True
