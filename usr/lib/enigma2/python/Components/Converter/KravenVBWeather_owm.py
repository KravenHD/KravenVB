...
URL = 'http://api.openweathermap.org/data/2.5/forecast/daily?' + config.plugins.KravenVB.weather_owm_latlon.value + '&cnt=5&mode=json&appid=18e71a506ce3be00c0468bee55df993b'
WEATHER_DATA = None
WEATHER_LOAD = True
