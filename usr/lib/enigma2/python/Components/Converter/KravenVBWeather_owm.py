...
URL1 = 'http://api.openweathermap.org/data/2.5/forecast/daily?' + config.plugins.KravenVB.weather_owm_latlon.value + '&cnt=5&mode=json&appid=60e502f04cdafb43a8ca88f82c39c033'
URL2 = 'http://api.openweathermap.org/data/2.5/weather?' + config.plugins.KravenVB.weather_owm_latlon.value + '&cnt=5&mode=json&appid=60e502f04cdafb43a8ca88f82c39c033'
WEATHER_DATA1 = None
WEATHER_DATA2 = None
WEATHER_LOAD = True

class KravenVBWeather_owm(Poll, Converter, object):
