...
URL = 'http://realtek.accu-weather.com/widget/realtek/weather-data.asp?%s' % str(config.plugins.KravenVB.weather_realtek_latlon.value)
WEATHER_DATA = None
WEATHER_LOAD = True

class KravenVBWeather_realtek(Poll, Converter, object):
