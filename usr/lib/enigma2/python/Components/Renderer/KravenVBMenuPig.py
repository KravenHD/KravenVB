...
class KravenVBMenuPig(Renderer):
	...
	def onShow(self):
		if self.instance:
			config.plugins.KravenVB.PigMenuActive.value = True
			config.plugins.KravenVB.PigMenuActive.save()
			if self.Size:
	...
	def onHide(self):
		if self.instance:
			...
			config.plugins.KravenVB.PigMenuActive.value = False
			config.plugins.KravenVB.PigMenuActive.save()
