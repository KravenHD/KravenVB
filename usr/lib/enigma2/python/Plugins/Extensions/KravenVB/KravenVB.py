...
config.plugins.KravenVB.InfobarSelfColorR = ConfigSlider(default=120, increment=15, limits=(0,255))
config.plugins.KravenVB.InfobarSelfColorG = ConfigSlider(default=120, increment=15, limits=(0,255))
config.plugins.KravenVB.InfobarSelfColorB = ConfigSlider(default=120, increment=15, limits=(0,255))
config.plugins.KravenVB.BackgroundSelfColorR = ConfigSlider(default=120, increment=15, limits=(0,255))
config.plugins.KravenVB.BackgroundSelfColorG = ConfigSlider(default=120, increment=15, limits=(0,255))
config.plugins.KravenVB.BackgroundSelfColorB = ConfigSlider(default=120, increment=15, limits=(0,255))
...
config.plugins.KravenVB.EMCSelectionColors = ConfigSelection(default="none", choices = [
				("none", _("off")),
				("emc-colors-on", _("on"))
				])
				
config.plugins.KravenVB.EMCSelectionBackground = ConfigSelection(default="000050EF", choices = [
				("00F0A30A", _("amber")),
				("00B27708", _("amber dark")),
				("001B1775", _("blue")),
				("000E0C3F", _("blue dark")),
...
<screen name="KravenVB-Setup" position="0,0" size="1280,720" flags="wfNoBorder" backgroundColor="#00000000">
  ...
  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#00000000" halign="left" valign="center" position="820,665" size="220,26" text="Reset" transparent="1" />
  ...
  <eLabel position="845,165" size="372,40" text="Version: 3.0.0" font="Regular; 30" valign="center" halign="center" transparent="1" backgroundColor="#00000000" foregroundColor="#00ffffff" name="," />
...
"""
	...
	def mylist(self):
		...
		if config.plugins.KravenVB.RunningText.value == "startdelay=2000" or config.plugins.KravenVB.RunningText.value == "startdelay=4000" or config.plugins.KravenVB.RunningText.value == "startdelay=6000" or config.plugins.KravenVB.RunningText.value == "startdelay=8000" or config.plugins.KravenVB.RunningText.value == "startdelay=10000":
		...
		list.append(getConfigListEntry(_("______________________ Enhanced Movie Center ___________________"), ))
	...
	def GetPicturePath(self):
		try:
			...
			elif returnValue == "steptime=100" or returnValue == "steptime=66" or returnValue == "steptime=50":
			...
			elif returnValue == "size-20" or returnValue == "size-22" or returnValue == "size-24" or returnValue == "size-26" or returnValue == "size-28" or returnValue == "size-30":
	...
	def save(self):
		...
		try:
			...
			if config.plugins.KravenVB.BackgroundColor.value == "self":
				...
				self.skinSearchAndReplace.append(['name="KravenBackground" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + "000000", 'name="KravenBackground" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + self.skincolorbackgroundcolor])
			else:
				self.skinSearchAndReplace.append(['name="KravenBackground" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + "000000", 'name="KravenBackground" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + config.plugins.KravenVB.BackgroundColor.value])
			...
			if config.plugins.KravenVB.InfobarColor.value == "self":
				...
				self.skinSearchAndReplace.append(['name="KravenNameBackground" value="#A01B1775', 'name="KravenNameBackground" value="#BF' + self.skincolorinfobarcolor])
				if config.plugins.KravenVB.InfobarColorTrans.value == "00":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#26' + self.skincolorinfobarcolor])
				elif config.plugins.KravenVB.InfobarColorTrans.value == "26":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#4C' + self.skincolorinfobarcolor])
				elif config.plugins.KravenVB.InfobarColorTrans.value == "4C":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#7F' + self.skincolorinfobarcolor])
				elif config.plugins.KravenVB.InfobarColorTrans.value == "7F" or config.plugins.KravenVB.InfobarColorTrans.value == "BF":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#BF' + self.skincolorinfobarcolor])
			else:
				...
				self.skinSearchAndReplace.append(['name="KravenNameBackground" value="#A01B1775', 'name="KravenNameBackground" value="#BF' + config.plugins.KravenVB.InfobarColor.value])
				if config.plugins.KravenVB.InfobarColorTrans.value == "00":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#26' + config.plugins.KravenVB.InfobarColor.value])
				elif config.plugins.KravenVB.InfobarColorTrans.value == "26":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#4C' + config.plugins.KravenVB.InfobarColor.value])
				elif config.plugins.KravenVB.InfobarColorTrans.value == "4C":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#7F' + config.plugins.KravenVB.InfobarColor.value])
				elif config.plugins.KravenVB.InfobarColorTrans.value == "7F" or config.plugins.KravenVB.InfobarColorTrans.value == "BF":
					self.skinSearchAndReplace.append(['name="KravenIbarBackground" value="#4A1B1775', 'name="KravenIbarBackground" value="#BF' + config.plugins.KravenVB.InfobarColor.value])
			...
			if not config.plugins.KravenVB.ChannelSelectionStyle.value == "channelselection-style-nobile" or not config.plugins.KravenVB.ChannelSelectionStyle.value == "channelselection-style-nobile2" or not config.plugins.KravenVB.ChannelSelectionStyle.value == "channelselection-style-nobile-minitv":
				if config.plugins.KravenVB.ChannelSelectionServiceSize.value == "size-20":
				...
				if config.plugins.KravenVB.ChannelSelectionInfoSize.value == "size-20":
			...
			if config.plugins.KravenVB.BackgroundColorTrans.value == "19" or config.plugins.KravenVB.BackgroundColorTrans.value == "33" or config.plugins.KravenVB.BackgroundColorTrans.value == "59" or config.plugins.KravenVB.BackgroundColorTrans.value == "7F" or config.plugins.KravenVB.BackgroundColorTrans.value == "BF":
				if config.plugins.KravenVB.BackgroundColor.value == "self":
				...
				if config.plugins.KravenVB.BackgroundColor.value == "self":
					self.skinSearchAndReplace.append(['name="KravenBackground2" value="#00000000', 'name="KravenBackground2" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + self.skincolorbackgroundcolor])
				else:
					self.skinSearchAndReplace.append(['name="KravenBackground2" value="#00000000', 'name="KravenBackground2" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + config.plugins.KravenVB.BackgroundColor.value])
			
			### Menu (Logo, MiniTV)
			if config.plugins.KravenVB.Logo.value == "minitv":
				self.skinSearchAndReplace.append(['<ePixmap backgroundColor="KravenBackground3" pixmap="KravenVB/logo.png" position="930,100" size="200,200" alphatest="blend" />', '<widget source="session.VideoPicture" render="Pig" position="822,80" size="416,234" zPosition="3" backgroundColor="transparent" /><eLabel backgroundColor="#00000000" position="822,80" size="416,234" transparent="0" zPosition="2" /><eLabel backgroundColor="#001F1F1F" position="822,80" size="416,3" transparent="0" zPosition="4" /><eLabel backgroundColor="#001F1F1F" position="822,311" size="416,3" transparent="0" zPosition="4" /><eLabel backgroundColor="#001F1F1F" position="822,80" size="3,234" transparent="0" zPosition="4" /><eLabel backgroundColor="#001F1F1F" position="1235,80" size="3,234" transparent="0" zPosition="4" /><ePixmap backgroundColor="KravenBackground3" pixmap="KravenVB/logo2.png" position="980,489" size="100,100" alphatest="blend" />'])
				if config.plugins.KravenVB.BackgroundColor.value == "self":
				...
				if config.plugins.KravenVB.BackgroundColor.value == "self":
					self.skinSearchAndReplace.append(['name="KravenBackground3" value="#00000000', 'name="KravenBackground3" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + self.skincolorbackgroundcolor])
				else:
					self.skinSearchAndReplace.append(['name="KravenBackground3" value="#00000000', 'name="KravenBackground3" value="#' + config.plugins.KravenVB.BackgroundColorTrans.value + config.plugins.KravenVB.BackgroundColor.value])
			...
			if not config.plugins.KravenVB.RunningText.value == "movetype=none":
				...
				if config.plugins.KravenVB.RunningTextSpeed.value == "steptime=100":
	...
	def restartGUI(self, answer):
		if answer is True:
			...
			config.skin.save()
			configfile.save()
			if fileExists("/usr/share/enigma2/KravenVB/header-kraven/ibar_000000.png"):
				rmtree('/usr/share/enigma2/KravenVB/header-kraven')
